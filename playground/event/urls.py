...
from .views import optIn_publicEvents, list_publicEvents,publish_event,optOut_publicEvents,retag_all_events,clear_all_event_tags,optOut_allOptedInEvents
...
urlpatterns = [
    ...
    path('optOut_allOptedInEvents', optOut_allOptedInEvents, name='optOut_allOptedInEvents'),
